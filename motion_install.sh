...
CONFIGFOLDER='/root/.motioncore'
COIN_DAEMON='motiond'
COIN_CLI='motion-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/motioncrypto/motion/releases/download/v0.1.2/motion-v0.1.2-lin-64bits.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
SENTINEL_REPO='https://github.com/motioncrypto/sentinel.git'
COIN_NAME='Motion'
COIN_PORT=7979
RPC_PORT=3385
